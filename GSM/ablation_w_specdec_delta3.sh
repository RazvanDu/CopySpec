...
for run in {1..2}; do
  ...
  python fastchat/llm_judge/gen_model_answer.py --model-path Qwen/Qwen2.5-32B-Instruct --draft-path Qwen/Qwen2.5-7B-Instruct --model-id Qwen/Qwen2.5-32B-Chat-experiments-large-specdec-5-copy-3-$run --delta 3 --use-copy True --gamma 3
...
for run in {1..2}; do
  ...
  python fastchat/llm_judge/gen_model_answer.py --model-path Qwen/Qwen2.5-32B-Instruct --draft-path Qwen/Qwen2.5-7B-Instruct --model-id Qwen/Qwen2.5-32B-Chat-experiments-large-specdec-5-copy-3-redundant-$run --delta 3 --use-copy True --gamma 3 --use-redundant True
