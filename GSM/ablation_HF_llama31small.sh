...
for run in {1..2}; do
  ...
  python cp_gsm_cot.py --model-path "meta-llama/Llama-3.1-8B-Instruct"
...
for run in {1..2}; do
  ...
  python cp_gsm_cot.py --model-path "meta-llama/Llama-3.1-8B-Instruct" --use-copy True --gamma 3
