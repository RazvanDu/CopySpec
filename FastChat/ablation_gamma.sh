...
for gamma in {1..10}; do
  ...
  for run in {1..2}; do
    ...
    python fastchat/llm_judge/gen_model_answer.py --model-path meta-llama/Llama-3.1-8B-Instruct --model-id llama3-8B-experiments-copy --use-copy True --gamma $gamma
