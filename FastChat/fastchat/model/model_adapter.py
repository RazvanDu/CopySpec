...
def load_model(
    ...
    os.environ["HF_DATASETS_CACHE"] = cache_directory
    ...
    def load_model(self, model_path: str, from_pretrained_kwargs: dict):
        ...
        model = AutoModel.from_pretrained(
            model_path, trust_remote_code=True, 
                cache_dir=cache_directory, **from_pretrained_kwargs
        )
        return model, tokenizer
...
class XGenAdapter(BaseModelAdapter):
    ...
    def load_model(self, model_path: str, from_pretrained_kwargs: dict):
        ...
        tokenizer = AutoTokenizer.from_pretrained(
            model_path, trust_remote_code=True, revision=revision, cache_dir=cache_directory,
        )
...
class InternLMChatAdapter(BaseModelAdapter):
    ...
    def load_model(self, model_path: str, from_pretrained_kwargs: dict):
        ...
        tokenizer = AutoTokenizer.from_pretrained(
            model_path, trust_remote_code=True, cache_dir=cache_directory, revision=revision
        )
        return model, tokenizer
...
class CuteGPTAdapter(BaseModelAdapter):
    ...
    def load_model(self, model_path: str, from_pretrained_kwargs: dict):
        ...
        model = AutoModelForCausalLM.from_pretrained(
            model_path, low_cpu_mem_usage=True, cache_dir=cache_directory, **from_pretrained_kwargs
        )
...
class OpenOrcaAdapter(BaseModelAdapter):
    ...
    def load_model(self, model_path: str, from_pretrained_kwargs: dict):
        revision = from_pretrained_kwargs.get("revision", "main")
        tokenizer = AutoTokenizer.from_pretrained(
            model_path, use_fast=self.use_fast_tokenizer, cache_dir=cache_directory, revision=revision
        )
        model = AutoModelForCausalLM.from_pretrained(
            model_path,
            low_cpu_mem_usage=True,
